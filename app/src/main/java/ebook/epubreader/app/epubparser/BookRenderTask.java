    ...
    protected ViewPagerAdapter doInBackground(String[] objects) {
        ...
        try {
            ...
            for(Resource resource:book.getContents()){
                ...
                adapter.addFragment(new WebFragment().newInstance(sb.toString(),outPutFolder,(book.getTitle()!=null ? book.getTitle() : ""), String.valueOf(i)+"/"+book.getContents().size(),fragmentPageClick));
